...
def comm_temp_and_prec():
    comm_t_and_p = """Temperature and precipitation (past and forcasted) \n \n \n
                      This figure show the average monthly temperature and precipitation for the past 31 years and the forcasted
